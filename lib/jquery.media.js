 ...
 *
 * @param options
 * @param {Function} f1 callback fn invoked for each matched element before conversion
 * @param {Function} f2 callback fn invoked for each matched element after conversion
 */
